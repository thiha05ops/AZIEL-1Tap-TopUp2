(function (root) {
    ...
    function calculateBasePrice(input) {
        ...
        trace(breakdown, { stage: "SUPPLIER_FEE", label: "Supplier fee", inputAmount: before, ruleType: supplierFee.rule.type, ruleValue: supplierFee.rule.value, amountAdded: supplierFee.amount, outputAmount: subtotal, currency: supplierCurrency });
        ...
        trace(breakdown, { stage: "BUSINESS_COST", label: "Business cost", inputAmount: before, ruleType: businessCost.rule.type, ruleValue: businessCost.rule.value, amountAdded: businessCost.amount, outputAmount: subtotal, currency: supplierCurrency });
        ...
        trace(breakdown, { stage: "PROFIT", label: "Profit and markup", inputAmount: before, ruleType: profit.rule.type, ruleValue: profit.rule.value, amountAdded: profitAmount, outputAmount: subtotal, currency: supplierCurrency });
