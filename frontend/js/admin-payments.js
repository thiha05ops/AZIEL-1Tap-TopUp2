        ...
        return `
            <div class="payment-method-card" data-id="${escapeAdminHTML(method._id)}">
                <div class="payment-header">
                    <div>
                        <h4>${escapeAdminHTML(displayName)} <small>${escapeAdminHTML(method.region || "")}</small></h4>
                ...
                <div class="settings-row">
                    ...
                    <select class="pm-provider">
                        ...
                        <option value="omise" ${provider === "omise" ? "selected" : ""}>PromptPay</option>
                        <option value="scb" ${provider === "scb" ? "selected" : ""}>SCB</option>
                        <option value="kplus" ${provider === "kplus" ? "selected" : ""}>KBZPay</option>
                        <option value="bbl" ${provider === "bbl" ? "selected" : ""}>Bangkok Bank</option>
                        <option value="ktb" ${provider === "ktb" ? "selected" : ""}>PromptPay</option>
                        <option value="krungsri" ${provider === "krungsri" ? "selected" : ""}>PromptPay</option>
                        <option value="ttb" ${provider === "ttb" ? "selected" : ""}>PromptPay</option>
                ...
                ${method.key === "promptpay" ? `
                    <div class="payment-method-hint">
                        ...
                        <span>Use paymentType <b>auto</b> and provider <b>omise</b>. QR is generated by the PromptPay provider flow.</span>
                    </div>
                ` : ""}
