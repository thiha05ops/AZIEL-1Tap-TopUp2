            ...
            <div class="payment-method-card" data-id="${escapeAdminHTML(method._id)}" data-key="${escapeAdminHTML(method.key || "")}" data-region="${escapeAdminHTML(method.region || "")}">
                ...
                <div class="settings-row">
                    ...
                    <select class="pm-qr-mode">
                        <option value="provider_generated" ${method.qrMode === "provider_generated" ? "selected" : ""}>Provider Generated</option>
                ...
                <div class="payment-capability-details">
                    ...
                    <div class="settings-row">
                        <div>
                            <label>Deeplink URL</label>
                            <small>Validated app URL, for example bankapp://</small>
                        </div>
                    ...
                    <div class="settings-row">
                        ...
                        <input class="pm-app-store" type="text" value="${escapeAdminHTML(method.appStoreUrl || "")}">
                    </div>
                    ...
                    <div class="settings-row">
                        ...
                        <input class="pm-play-store" type="text" value="${escapeAdminHTML(method.playStoreUrl || "")}">
                    </div>
                </div>
...
function getAdminPaymentReadiness(method = {}) {
    ...
    if (type !== "wallet" && type !== "auto") {
        ...
        if (!(method.qrImage || method.qrImageUrl || method.uploadedQrImage)) missing.push("QR image");
    }
...
function refreshPaymentEditorVisibility(card) {
    ...
    const isPromptPay = state.key === "promptpay" || state.paymentType === "auto";
    ...
    if (openWarning) {
        const canOpen = Boolean(card.querySelector(".pm-deeplink")?.value && appName);
