...
function verifyModuleIntegrationAndRegressions() {
    ...
    assert(html.includes("Exchange Rate") && html.includes("Profit Policy") && html.includes("Gateway Fee") && html.includes("Minimum Profit"), "Pricing Settings controls must render.");
