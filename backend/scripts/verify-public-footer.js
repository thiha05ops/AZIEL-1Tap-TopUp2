...
function main() {
    ...
    assert(css.includes("width: min(var(--public-page-max, 1200px)"), "Footer must use the shared public max-width.");
    ...
    assert(css.includes("padding-bottom: max(96px"), "Mobile footer must leave room for Live Chat/safe area.");
