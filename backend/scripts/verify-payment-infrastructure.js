...
function verifyRouteAndFrontendContracts() {
    ...
    includes("frontend/admin.html", "/js/admin-payments.js?v=20260910-tmw-admin-method", "Admin must publish the repaired payment controller under a fresh versioned asset URL.");
