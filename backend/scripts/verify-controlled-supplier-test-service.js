...
async function main() {
    const mapping = { _id: id("m1"), supplierId: "s1", supplierCode: "FAZERCARDS", productCode: "freefire", packageCode: "FF_33_DIA", productionRole: "DISABLED", archivedAt: null, toObject() { return this; } };
    ...
    const input = { explicitApproval: true, approvalPhrase: "EXECUTE EXACTLY ONE CONTROLLED SUPPLIER TEST", authorizationToken: "one-use-secret", supplier: "FAZERCARDS", product: "freefire", packageCode: "FF_33_DIA", mappingId: "m1", orderId: "o1", attemptId: "a1" };
