...
const ADMIN_AUDIT_ACTIONS = Object.freeze({
    ...
    CATALOG_PRODUCT_REMOVED: "CATALOG_PRODUCT_REMOVED",
    CATALOG_PRODUCT_RESTORED: "CATALOG_PRODUCT_RESTORED",
    ...
    CATALOG_PACKAGE_RESTORED: "CATALOG_PACKAGE_RESTORED",
    CATALOG_PACKAGE_REORDERED: "CATALOG_PACKAGE_REORDERED",
    PACKAGE_MARKET_PUBLISHED: "PACKAGE_MARKET_PUBLISHED",
    PACKAGE_MARKET_UNPUBLISHED: "PACKAGE_MARKET_UNPUBLISHED",
    GAME_BANNER_CREATED: "GAME_BANNER_CREATED",
    GAME_BANNER_UPDATED: "GAME_BANNER_UPDATED",
    GAME_BANNER_REMOVED: "GAME_BANNER_REMOVED",
    GAME_BANNER_RESTORED: "GAME_BANNER_RESTORED",
    GAME_BANNER_REORDERED: "GAME_BANNER_REORDERED",
    STOREFRONT_SECTION_UPDATED: "STOREFRONT_SECTION_UPDATED",
    STOREFRONT_SECTION_REORDERED: "STOREFRONT_SECTION_REORDERED",
    ...
    PRICING_DRAFT_SAVED: "PRICING_DRAFT_SAVED",
    PRICING_PUBLISHED: "PRICING_PUBLISHED",
    PROMOTION_NOTIFICATION_CREATED: "PROMOTION_NOTIFICATION_CREATED",
    PROMOTION_NOTIFICATION_UPDATED: "PROMOTION_NOTIFICATION_UPDATED",
    PROMOTION_NOTIFICATION_PUBLISHED: "PROMOTION_NOTIFICATION_PUBLISHED",
    PROMOTION_NOTIFICATION_DISABLED: "PROMOTION_NOTIFICATION_DISABLED",
    ...
    PRODUCT_SOURCE_PREPARATION_PLANNED: "PRODUCT_SOURCE_PREPARATION_PLANNED",
    PRODUCT_SOURCE_PREPARED: "PRODUCT_SOURCE_PREPARED",
    STORE_CATALOG_SELECTION_SAVED: "STORE_CATALOG_SELECTION_SAVED",
    STORE_CATALOG_SELLING_MARKETS_CHANGED: "STORE_CATALOG_SELLING_MARKETS_CHANGED",
    ...
    SUPPLIER_INPUT_CONTRACT_APPROVED: "SUPPLIER_INPUT_CONTRACT_APPROVED",
    SUPPLIER_ROUTE_TECHNICALLY_PREPARED: "SUPPLIER_ROUTE_TECHNICALLY_PREPARED",
