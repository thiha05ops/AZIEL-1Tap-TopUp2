...
function publicManualAttempt(attempt) {
    const instructions = {
        ...
        confirmationMode: attempt.instructions?.confirmationMode || "",
        ...
        openAppMode: attempt.instructions?.openAppMode || "disabled",
    ...
    return {
        ...
        openAppMode: instructions.openAppMode,
...
async function createOrderFromManualAttempt(attempt, evidence, username) {
    ...
    const orderPayload = {
        ...
        paymentExecutionPolicy: {
            paymentMethodKey: attempt.paymentMethod,
            paymentMethodDisplayName: attempt.instructions?.method || attempt.paymentMethod,
